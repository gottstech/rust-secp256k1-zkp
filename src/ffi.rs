...
pub struct PublicKey(
    #[serde(serialize_with = "u8_to_hex", deserialize_with = "hex_to_sig")] pub [c_uchar; 64],
);
...
pub struct RecoverableSignature(
    #[serde(serialize_with = "u8_to_hex", deserialize_with = "hex_to_rsig")] [c_uchar; 65],
);
...
pub struct AggSigPartialSignature(
    #[serde(serialize_with = "u8_to_hex", deserialize_with = "hex_to_key")] [c_uchar; 32],
);
